...
_Log.prototype.log = function(str, type, level) {
    ...
    if(type == Log.TYPE.INFO)
        ...
        logStream.write(getDatePrefix(false) + ' ' + type.name + ' ' + str.stack + '\n');
...
_Log.prototype.sendEventsPerSecond = function(nb) {
    console.log(Log.TYPE.MONITORING.name + ' ' + Log.LEVEL_MONITORING.EVENTS_PER_SECOND.name + ' ' + nb);
}
...
Log.LEVEL_MONITORING = {
    EVENTS_PER_SECOND  : {value: 1, name: "EVENTS_PER_SECOND"}
};
