...
model.Client.prototype.joinRoom = function(id) {
     ...
     if(typeof g != 'undefined') {
          ...
          model.linkIO.log("[" + this.login + " - (" + this.role + ")] joined room [" + g.id + "]", model.linkIO.log.TYPE.INFO, model.linkIO.log.LEVEL.DEBUG);
...
model.Room = function(user, id) {
     ...
     model.linkIO.log("[" + user.login + " - (" + user.role + ")] created and joined room [" + this.id + "]", model.linkIO.log.TYPE.INFO, model.linkIO.log.LEVEL.DEBUG);
}
